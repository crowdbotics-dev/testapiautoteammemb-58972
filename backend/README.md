...
## Project Structure
    ...
    ├── testapiautoteammemb_58972  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_58972`
...
2. Clone this repo and `cd testapiautoteammemb_58972`
